...
public class DBSlowRunner extends JPanel {
    ...
    public static void main(String args[]) {
        ...
        gamecount.setBounds(10, 440, 200, 150);                         //total gamecount label
        frame.add(gamecount);

        betLabel.setBounds(10, 465, 200, 150);                          //current bet amount label
        frame.add(betLabel);

        generalLabel.setBounds(670, 295, 100, 150);                  //instruction label
        frame.add(generalLabel);

        wolLabel.setBounds(250, 480, 500, 150);                         //displayed at bottom whether you won or lost
        frame.add(wolLabel);
